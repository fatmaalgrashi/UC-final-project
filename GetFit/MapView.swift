    ...
    func updateUIView(_ view: MKMapView, context: Context) {
        ...
        if deltaUnit == "degrees" {
             ...
             ***1 degree = 111 kilometers = 69 miles***
             ...
             latitudeDelta: North-to-south distance in degrees to display in map region
             longtitudeDelta: East-to-west distance in degrees to display in map region.
             */
             ...
             ***1609.344 meters = 1.609344 kilometers = 1 mile***
